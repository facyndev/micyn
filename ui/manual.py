...
def show_manual(parent):
    ...
    ctk.CTkLabel(sf, text="¿Cómo usar Micyn con OBS?", font=ttl_font, text_color="#FFFFFF", anchor="w").pack(fill="x", pady=(0, 15))
